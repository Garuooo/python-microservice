...
// The upstream module version used may not expose kubeconfig_config.
// Remove this output to avoid "unsupported attribute" errors.
// output "kubeconfig" {
//   description = "Kubeconfig for the EKS cluster"
//   value       = module.eks.kubeconfig_config
//   sensitive   = true
// }
